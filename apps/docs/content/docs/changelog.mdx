...
# this method you must specify the style, and cant be used for components that depend on other components, e.g new-york would be https://jollyui.dev/new-york/button
```
